...
export class PokemonService {
  ...
  getAllPokemonsByEvolutionFamilyId(
    evolutionFamilyId: number,
    id: number
  ): Pokemon[] {
    return this.getAll()
      .filter((pokemon) => pokemon.evolutionFamilyId === evolutionFamilyId)
  ...
  getAllTypes(): Type[] {
    return [
      ...
      { name: 'water', count: 32 },
      { name: 'grass', count: 14 },
      { name: 'poison', count: 33 },
      { name: 'flying', count: 20 },
      { name: 'normal', count: 22 },
      { name: 'bug', count: 12 },
      { name: 'electric', count: 9 },
      { name: 'ground', count: 14 },
      { name: 'dragon', count: 3 },
      { name: 'psychic', count: 14 },
      { name: 'fairy', count: 5 },
      { name: 'ice', count: 5 },
      { name: 'rock', count: 11 },
      { name: 'fighting', count: 8 },
      { name: 'steel', count: 2 },
      { name: 'ghost', count: 3 },
    ];
  }
